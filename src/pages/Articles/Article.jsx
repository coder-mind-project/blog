...
const Article = (props) => {
  ...
  return (
    <Grid className={ article && !article.bigImg ? 'article-wrapper' : 'article-container'}>
      { article && !isLoading &&
                    <Grid item xs={12} className="article-content">
                      { article.bigImg &&
                            <Grid item xs={12} className="article-header">
                              <img src={`/${article.bigImg}`} alt={article.longDescription}/>
                            </Grid>
                      }
                      ...
                      <Grid item xs={12} className="article-short-description">
                        <h2 className="short-description">{article.shortDescription}</h2>
                      </Grid>
                      <Grid item xs={12} className="header-hud-bar">
                        ...
                        {article.theme && article.theme.name &&
                        ...
                        <Grid item xs={12}>
                          <Box display="flex" justifyContent="center" alignItems="center" width="100%" id="share-options" tabIndex="-1">
                            <FacebookShareButton
                              ...
                              url={`/artigos/${match.params.resource}`}
                              quote={`Veja mais sobre ${article.title}`}
                            >
                              <FontAwesomeIcon
                            ...
                            <TwitterShareButton
                              ...
                              url={`/artigos/${match.params.resource}`}
                              title={`${article.title}`}
                              hashtags={[`${article.theme.name}`, `${article.title}`, 'Coder Mind']}
                            >
                            ...
                            <WhatsappShareButton
                              className="share-button"
                              url={`/artigos/${match.params.resource}`}
                              title={`Veja mais sobre ${article.title}`}
                              separator=" | "
                            >
                              <FontAwesomeIcon icon={faWhatsapp} size="2x" color="#58e870"/>
                            </WhatsappShareButton>
                            <TelegramShareButton
                              className="share-button"
                              url={`/artigos/${match.params.resource}`}
                            ...
                            { article.github &&
                              <Tooltip
                                title={
                                  <span>
                                    Este artigo possui código em nosso repositório,
                                    clique para visualizá-lo</span>
                                }
                              ...
                              >
                                <div>
                                  <FontAwesomeIcon
                                    ...
                                    size="2x"
                                    tabIndex="-1"
                                    onClick={() => window.open(article.github)}
                                  />
                                </div>
                              </Tooltip>}
                            { article.youtube &&
                              <Tooltip
                                title={<span>Este artigo possui um vídeo, clique para assisti-lo</span>}
                                placement="bottom-start">
                                <div>
                                  <FontAwesomeIcon
                                    icon={faYoutube}
                                    ...
                                    tabIndex="-1"
                                    color="red"
                                    onClick={() => window.open(article.youtube)}
                                  />
                                </div>
                              </Tooltip>}
                          </Box>
